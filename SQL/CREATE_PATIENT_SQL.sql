...
-- 刪除看診時段表格 DROP TABLE DOCTOR_SCHEDULE;
-- 新增看診時段表
CREATE TABLE DOCTOR_SCHEDULE (
    ...
    `DOCTOR_STATUS` BIT(1) DEFAULT 1 COMMENT '看診狀態',
    PRIMARY KEY (`SERIAL_NUMBER`),
    CONSTRAINT FK_DOCTOR_SCHEDULE_DOCTOR_ID FOREIGN KEY (DOCTOR_ID) REFERENCES DOCTOR(DOCTOR_ID)
);

-- 刪除病人表格 DROP TABLE PATIENT;
-- 建立病人表格PATIENT
CREATE TABLE PATIENT (
	`MEMBER_ID` VARCHAR(50) COMMENT '會員編號',
    ...
    PRIMARY KEY(`PATIENT_IDCARD`, `BOOKING_DATE`),
--   CONSTRAINT FK_PATIENT_MEMBER_ID FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER(MEMBER_ID),
...
('A123456789', '2022-07-12', '早', 1, 1),
('A123456789', '2022-07-16', '早', 1, 1),
('A123456789', '2022-07-20', '早', 1, 1),
('A123456789', '2022-07-22', '早', 1, 1),
('A123456789', '2022-07-23', '午', 1, 1),
