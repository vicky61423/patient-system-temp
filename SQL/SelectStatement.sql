...
UPDATE PATIENT SET CHART = ?  WHERE PATIENT_IDCARD = ? AND BOOKING_DATE = ?;
...
UPDATE DOCTOR_SCHEDULE SET DOCTOR_SCHEDULE_DATE = ?, DOCTOR_AMPM = ? , DOCTOR_STATUS = ? WHERE DOCTOR_ID= ?;