...
('TGA001','A123456788', '2022-07-12', '早', 1, 1,1, "主訴:患者表示左邊第一顆門牙疼痛。
診斷:齲齒。
治療內容:根管治療。
建議:加強每日三餐牙線清潔與漱口水使用。"),
('TGA002','A123456789', '2022-07-16', '早', 1, 1,1, "主訴:定期洗牙回診
診斷:檢查後無異狀
治療內容:全口洗牙
建議:持續維持目前清潔習慣"),
('TGA001','A123456788', '2022-07-20', '早', 1, 1, 1,"主訴:患者希望牙齒變白\n診斷:無。\n治療內容:上排牙齒冷光美白療程\n建議:第一周會較痠痛，建議搭配抗敏感牙膏使用"),
('TGA002','A123456789', '2022-07-22', '早', 1, 2, 0,""),
('TGA001','A123456788', '2022-07-23', '午', 1, 2, 0, ""),
('TGA002','A123456789', '2022-07-27', '午', 1, 2, 0, ""),
('TGA002','A123456789', '2022-07-28', '午', 1, 2, 0, "");
